...
| Tipo Lançamento | Select | Sim | Automático / Manual | Indica se o ajuste e gerado automaticamente ou manualmente. |
...
- **[VFIS0540 (Lançamentos Resumo ICMS)](/fiscal/vfis0540):** Lançamentos fiscais que utilizam os códigos de ajuste.
