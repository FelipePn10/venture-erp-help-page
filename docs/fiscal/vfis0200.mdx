...
12. Clique em **Transmitir**. O XML sera assinado digitalmente com o certificado A1 e enviado a SEFAZ via integração Focus NF-e. O status mudara para `Aguardando Retorno`. Acompanhe o progresso no painel de status.
